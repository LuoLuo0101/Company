...
class Announcement(models.Model):
    ...
    # 使用富文本改写
    content = UEditorField(verbose_name=u"公告内容",imagePath='announ/images/', filePath="announ/files/",help_text=u"公告内容")
    ...
    # 发布人
    publisher = models.ForeignKey(User, related_name="announ",verbose_name=u"发布人ID", help_text=u"发布人ID")
...
class Comments(models.Model):
    ...
    commenter = models.ForeignKey(User,related_name='comment',verbose_name=u"留言者", help_text=u"留言者")
...
class Articles(models.Model):
    ...
    author = models.ForeignKey(User, related_name='article', verbose_name=u"作者", help_text=u"作者")
    is_published = models.BooleanField(verbose_name=u"是否公开", default=True, help_text=u"是否公开")
